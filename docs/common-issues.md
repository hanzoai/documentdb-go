...
The [`bson.Marshal`](https://pkg.go.dev/github.com/hanzoai/documentdb-go/bson#Marshal) function requires a parameter that can be decoded into a BSON Document, i.e. a [`bson.D`](https://pkg.go.dev/github.com/hanzoai/documentdb-go/bson#D). Therefore the error message
...
There are a variety of marshalers that can be used to encode a BSON document as JSON, including [MarshalExtJSON](https://pkg.go.dev/github.com/hanzoai/documentdb-go/bson#MarshalExtJSON):
